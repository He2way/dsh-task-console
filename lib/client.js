...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function CanvasControlView(props) {
			const { card, onMove, onResize, onEdit, onChat, onDelete, onWidgetState, onBlockResize, onDuplicate, onBoard, onToggleBare, canvasId, onRebuild } = props;
		...
		function CanvasCardView(props) {
			const { card, scale, onMove, onResize, onEdit, onChat, onDelete, onWidgetState, onBlockResize, onFull, onDuplicate, onBoard, onToggleBare, onRebuild } = props;
			const ref = (0, react.useRef)(null);
			const gesture = (0, react.useRef)(null);
			const frame = (0, react.useRef)(0);
			const begin = (mode, event) => {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					(0, react_jsx_runtime.jsx)("div", { className: "dsh-tc-cardBody", children: card.plugin !== void 0
						...
						: (0, react_jsx_runtime.jsx)(TaskUserBodyView, { card, cardId: card.id, onWidgetState, onBlockResize }) }),
					(0, react_jsx_runtime.jsx)("div", {
						className: "dsh-tc-cardResize",
						title: "拖动调整卡片大小",
						onPointerDown: (event) => begin("resize", event),
			...
			const cardView = (id) => {
				...
				if (id === "session") {
					...
					body = layout.plugin !== void 0
						...
						: (0, react_jsx_runtime.jsx)(TaskUserBodyView, { card: layout, cardId: id, onWidgetState: setWidgetState, onBlockResize: resizeEmbedBlock, thumbnail: true });
				} else {
					title = "工作区";
