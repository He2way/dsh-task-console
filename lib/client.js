...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function CanvasCardView(props) {
			const { card, scale, onMove, onResize, onEdit, onChat, onDelete, onWidgetState, onBlockResize, onFull } = props;
		...
		function TaskBackPanel(props) {
			...
			const cardView = (id) => {
				...
				const actions = [
					{ key: "full", icon: "⛶", title: "全屏显示这张卡片（Esc 退出）", onClick: () => setFullCardId(id) },
