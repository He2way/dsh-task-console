...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function TaskBackPanel(props) {
			const { useSessions, onClose, plugins, modules } = props;
		...
		function TaskConsoleRoot(props) {
			...
			return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				...
				(open || closing) && portalTarget !== null ? (0, react_dom.createPortal)((0, react_jsx_runtime.jsx)("div", {
					...
					children: (0, react_jsx_runtime.jsx)(TaskBackPanel, { useSessions, onClose: requestClose, plugins: taskPluginsPort, modules: taskModulesPort })
				}), portalTarget) : null
			] });
		}
		//#endregion
