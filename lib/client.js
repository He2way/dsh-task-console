...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const TASK_CSS_EXTRA = [
			...
			".dsh-tc-appWrap{position:relative;flex:1;min-height:0;background:#fff}",
		...
		function TaskBlockView(props) {
			...
			if (block.kind === "embed") return (0, react_jsx_runtime.jsx)(TaskEmbedView, { block });
