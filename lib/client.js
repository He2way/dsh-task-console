		...
		function ensureTaskBridgeMonitor(target) {
			...
			const connect = () => {
				...
				socket.addEventListener("message", (event) => {
					...
					setTaskBridgePageState(target, {
						state: message.state === "connected" ? "connected" : "disconnected",
