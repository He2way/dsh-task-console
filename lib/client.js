...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const TASK_CSS_EXTRA = [
			...
			".dsh-tc-canvasChat{position:absolute;right:16px;bottom:16px;z-index:40;display:flex;flex-direction:column;width:340px;max-width:calc(100% - 32px);border-radius:14px;border:1px solid rgba(148,163,184,.32);background:rgba(255,255,255,.84);backdrop-filter:blur(14px) saturate(160%);-webkit-backdrop-filter:blur(14px) saturate(160%);box-shadow:0 18px 46px rgba(15,23,42,.26);overflow:hidden;animation:dsh-tc-dock-in .2s cubic-bezier(.22,1,.36,1) both}",
